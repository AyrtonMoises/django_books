...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','django-books-ecommerce.herokuapp.com']
...
MIDDLEWARE = [
    ...
    'checkout.middleware.carrinho_middleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'template_tags': 'templates.template_tags',
            }
        },
    },
]
...
THUMBNAIL_ALIASES = {
    '': {
        'livro_img': {'size': (156, 200), 'crop': True },
    }
}
